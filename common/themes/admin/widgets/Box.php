    ...
    protected function initButtons()
    {
        if (!isset($this->buttons['create'])) {
            $this->buttons['create'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Yii::t('theme/widgets/box', 'Create')
                ]
            ];
        }
        ...
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Yii::t('theme/widgets/box', 'Delete'),
                    'data-confirm' => Yii::t('theme/widgets/box', 'Are you sure you want to delete this item?'),
                    'data-method' => 'delete'
                ]
            ];
        }
        ...
        if (!isset($this->buttons['batch-delete'])) {
            $this->buttons['batch-delete'] = [
                ...
                'options' => [
                    'id' => 'batch-delete',
                    'class' => 'btn-default',
                    'title' => Yii::t('theme/widgets/box', 'Delete selected')
                ]
            ];
        }
        ...
        if (!isset($this->buttons['cancel'])) {
            $this->buttons['cancel'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Yii::t('theme/widgets/box', 'Cancel')
                ]
            ];
        }
        
        if (!isset($this->buttons['parent'])) {
            $this->buttons['parent'] = [
                'url' => ['index', 'parent' => $this->options['parent']],
                'icon' => 'fa-arrow-up',
                'options' => [
                    'class' => 'btn-default',
                    'title' => Yii::t('theme/widgets/box', 'Parent'),
//                    'data-method' => 'delete'
                ]
            ];
        }

        if (!isset($this->buttons['search'])) {
            $this->buttons['search'] = [
                'url' => ['delete', $this->deleteParam => Yii::$app->request->get($this->deleteParam)],
                'icon' => 'fa-search',
                'options' => [
                    'class' => 'btn-default',
                    'title' => Yii::t('theme/widgets/box', 'Search'),
                    'data-confirm' => Yii::t('theme/widgets/box', 'Are you sure you want to delete this item?'),
                    'data-method' => 'delete'
                ]
            ];
