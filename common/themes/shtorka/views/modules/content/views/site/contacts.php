...
<!-- Head Section -->
<section class="page-section bg-dark-alfa-90 parallax-3" data-background="<?= Yii::$app->assetManager->publish('@common/themes/shtorka/assets/images/photo_for_template/8.jpg')[1] ?>">
    ...
    <div class="container relative">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4 pt-20 pb-20 pb-xs-0">
                        <div class="contact-item">
                            ...
                            <div class="ci-text">
                                <a href="mailto:manager@shtorka.kz">manager@shtorka.kz</a>
                            </div>
                        </div>
                    </div>
                    <!-- End Email -->
        ...
        <div class="row">
            ...
            <div class=" col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <img src="<?= Yii::$app->assetManager->publish('@common/themes/shtorka/assets/images/photo_for_template/map1.jpg')[1] ?>">
