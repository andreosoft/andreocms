...
<div class="page_content_offset" style="padding-top:0px;">
    <div class="container">
        <div class="clearfix m_bottom_30 t_xs_align_c">
            <div class="photoframe type_2 shadow r_corners f_left f_sm_none d_xs_inline_b product_single_preview relative m_right_30 m_bottom_5 m_sm_bottom_20 m_xs_right_0 w_mxs_full">
                <div class="relative d_inline_b m_bottom_10 qv_preview d_xs_block">
                    <?= Html::img(Image::thumb($model->image, 438, 438))?>
                </div>
            </div>
        ...
        <?php foreach (CatalogProducts::find()->where(['isparent' => 'false', 'status' => CatalogProducts::STATUS_PUBLISHED])->andWhere('id <> '.$model->id)->orderBy('RAND()')->limit(4)->all() as $model):?>
            <!--product item-->
            <div class="product_item w_xs_full">
                <figure class="r_corners photoframe animate_ftb type_2 t_align_c tr_all_hover shadow relative">
                    <?= Html::a(Html::img(Image::thumb($model->image, 80, 80), ['class' => 'tr_all_hover']),['/catalog/site/view-by-url', 'url' => $model->seo_url], ['class' => 'd_block relative pp_wrap m_bottom_15'])?>
                    <figcaption>
