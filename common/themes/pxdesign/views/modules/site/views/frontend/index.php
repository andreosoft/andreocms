            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="item">
                        ...
                        <p>Разработка красивых и быстрых сайтов с учетом всех ваших пожеланий. В итоге Вы получаете индивидуально разработанный сайт, соответствующий всем Вашим ожиданиям и требованиям. <a href="<?= Url::to(['/content/site/view-by-url', 'url' => 'Разработка+сайтов'])?>">Подробнее...</a></p></p>
                    </div>
                    <div class="item">
                        ...
                        <p>Наша задача - сделать так, чтобы поисковики высоко оценивали Ваш сайт и правильно определяли ключевые слова для каждой страницы сайта. Высокие позиции в поиске обеспечивают приток потенциально заинтересованных посетителей. <a href="<?= Url::to(['/content/site/view-by-url', 'url' => 'Поисковая+оптимизация'])?>">Подробнее...</a></p></p> 
                    </div>        
                </div>
                ...
                <div class="span6">
                    <div class="item">
                        ...
                        <p>Контекстная реклама - современная рекламная технология, которая позволяет показывать рекламу человеку в зависимости от его интересов. По эффективности в разы превосходит классические оффлайн площадки. <a href="<?= Url::to(['/content/site/view-by-url', 'url' => 'Контекстная+реклама'])?>">Подробнее...</a></p> 
                    </div>
                    <div class="item">
                        ...
                        <p>Социальные сети - это такой же канал маркетинговых коммуникаций, как реклама на ТВ или участие в профильной выставке. Используя социальные сети, можно эффективно решать маркетинговые задачи и в разы увеличивать эффективность рекламы. <a href="<?= Url::to(['/content/site/view-by-url', 'url' => 'SMO+и+SMM'])?>">Подробнее...</a></p></p> 
                    </div>
                </div>
            </div>
        </div>
