    ...
    <div class="container">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin: 10px 0 10px 0;">
                        <a href="<?= Url::to(['/catalog/site/index', 'parent' => $model->id])?>" class="d_block animate_ftb h_md_auto m_xs_bottom_15 banner_type_2 r_corners green t_align_c tt_uppercase vc_child n_sm_vc_child">
                            <span class="d_inline_middle">
                                <?= Html::img(File::thumb($model->image, 56, 56), ['class' => 'd_inline_middle m_md_bottom_5']) ?>
            ...
            <div class="product_item w_xs_full">
                <figure class="r_corners photoframe animate_ftb type_2 t_align_c tr_all_hover shadow relative">
                    <a href="#" class="d_block relative pp_wrap m_bottom_15">
                        <?= Html::img(File::thumb($model->image, 242, 242), ['class' => 'tr_all_hover']) ?>
                    </a>
                    <figcaption>
                        <h5 class="m_bottom_10"><?= Html::a($model->name, ['/catalog/site/view-by-url' => $model->seo_url], ['class' => 'color_dark'])?></h5>
        ...
        <div class="row clearfix">
            <div class="col-lg-6 col-md-6 col-sm-6 m_bottom_45 m_xs_bottom_30">
                <h2 class="tt_uppercase color_dark m_bottom_10">Компания "Я-Свет"</h2>
        ...
        <div class="clearfix m_bottom_25 m_sm_bottom_20">
            <h2 class="tt_uppercase color_dark f_left heading2 animate_fade f_mxs_none m_mxs_bottom_15">Наши бренды</h2>
        ...
        <div class="product_brands m_bottom_45 m_sm_bottom_35">
            <?php foreach (Content::findAll(['class' => 'brands', 'status' => Content::STATUS_PUBLISHED]) as $model):?>
                <?= Html::a(Html::img(File::thumb($model->image, 160, 78)), ['/content/site/view-by-url', 'url' => $model->seo_url], ['class' => 'd_block t_align_c animate_fade'])?>
            <?php endforeach; ?>
        </div>
    </div>
</div>