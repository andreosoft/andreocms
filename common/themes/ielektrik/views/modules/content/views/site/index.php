        ...
        <div class="row clearfix">
            ...
            <section class="col-lg-9 col-md-9 col-sm-9">
                ...
                <article class="m_bottom_20 clearfix">
                    <?= Html::a(Html::img(File::thumb($model->image, 350, 220), ['class' => 'tr_all_long_hover']), ['/content/site/view-by-url', 'url' => $model->seo_url, 'view' => 'view'], ['class' => 'photoframe d_block d_xs_inline_b f_xs_none wrapper shadow f_left m_right_20 m_bottom_10 r_corners'])?>
                    ...
                    <div class="widget_content">
                        ...
                        <?php foreach (Content::find()->where(['class' => 'blog', 'status' => Content::STATUS_PUBLISHED])->orderBy('RAND()')->limit(3)->all() as $model): ?>
                            ...
                            <article class="clearfix m_bottom_15">
                                <?= Html::img(File::thumb($model->image, 80, 80), ['class' => 'f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0']) ?>
