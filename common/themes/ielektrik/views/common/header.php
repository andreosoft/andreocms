    ...
    <section class="h_bot_part container">
        <div class="clearfix row">
            <div class="col-lg-4 col-md-6 col-sm-4 t_xs_align_c">
                <a href="<?= \Yii::$app->homeUrl?>" class="logo m_xs_bottom_15 d_xs_inline_b">
                    <img src="<?= Yii::$app->assetManager->publish('@common/themes/ielektrik/assets/images/ie-logo.png')[1]?>" alt=""> <br /><h3>Светотехника для Вас</h3>
                </a>
            </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-6 t_align_r t_xs_align_c m_xs_bottom_15" style="margin-top: -10px;">
                        <dl class="l_height_medium">
                            ...
                            <dd class="f_size_ex_large color_dark"><a data-toggle="modal" data-target="#modalCallback"><b>8 (960) 100-32-32</b><br /> <small>Нажмите для звонка</small></a></dd>
                        </dl>
                    </div>
        ...
        <section class="menu_wrap type_2 relative clearfix t_xs_align_c m_bottom_20">
            ...
            <nav role="navigation" class="f_left f_xs_none d_xs_none t_xs_align_l">	
                <ul class="horizontal_list main_menu clearfix">
                    ...
                    <li class="<?= Yii::$app->request->url === Url::to(['/content/site/view-by-url', 'url' => 'о_компании', 'view' => 'view']) ? 'current' : ''?> relative f_xs_none m_xs_bottom_5"><?= Html::a('<b>О компании</b>',['/content/site/view-by-url', 'url' => 'о_компании', 'view' => 'view'] , ['class' => 'tr_delay_hover color_light tt_uppercase'])?></li>
